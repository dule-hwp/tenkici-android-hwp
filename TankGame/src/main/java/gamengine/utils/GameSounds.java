...
//            clip.open(AudioSystem.getAudioInputStream(TankWorld.class.getResource(filename)));
...
//            public void run() {
//            	try {
//                AudioInputStream in= AudioSystem.getAudioInputStream(TankWorld.class.getResource(filename));
