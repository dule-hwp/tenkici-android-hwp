...
public class JoystickView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // Draw the background
        canvas.drawCircle(px, py, radius - innerPadding-handleRadius, circlePaint);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (actionType == MotionEvent.ACTION_MOVE) {
            ...
            angle = Math.toDegrees(Math.atan2(touchY,touchX));
//            angle+= touchX<0 ? 180 :0;
            // Coordinates
//            Log.d(TAG, "X:" + touchX + "|Y:" + touchY + "|angle:" + angle);

            // Pressure
            if (listener != null) {
                listener.OnMoved(angle, getHypo(touchX,touchY), radius);
            }
...
//            Log.d(TAG, "X:" + touchX + "|Y:" + touchY);
    ...
    private double getHypo(double a, double b){
